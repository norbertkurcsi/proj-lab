...
public class MenuPanel extends JPanel {
    ...
    public MenuPanel() {
        ...
        // inventoryPanel.setPreferredSize(new Dimension(Window.WIDTH, Window.HEIGHT /
        // 5));
        ...
        // File("Chalkduster.ttf")).deriveFont(30f);
        ...
        // Window.getGraphics2D(g).drawImage(pumpImage, 0, 0, Window.BUTTONSIZE,
        // Window.BUTTONSIZE, null);
        // }
        // }
        // };
        ...
        // Window.getGraphics2D(g).drawImage(pipeImage, 0, 0, Window.BUTTONSIZE,
        // Window.BUTTONSIZE, null);
        // }
        // }
        // };
        ...
        // protected void paintComponent(Graphics g) {
        // Window.getGraphics2D(g).drawImage(mechanicImage, 0, 0, Window.BUTTONSIZE -
        // 10, Window.BUTTONSIZE - 10,
        // null);
        // }
        // };
        // JButton scoreSaboteur = new JButton() {
        // protected void paintComponent(Graphics g) {
        // Window.getGraphics2D(g).drawImage(saboteurImage, 0, 0, Window.BUTTONSIZE -
        // 10, Window.BUTTONSIZE - 10,
        // null);
        // }
        // };
